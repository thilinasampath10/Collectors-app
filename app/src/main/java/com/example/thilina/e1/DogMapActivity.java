...
public class DogMapActivity extends AppCompatActivity implements OnMapReadyCallback {

    final String Url = "http://192.168.8.100:8000/api/getDogFoodLocations";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(DogMapActivity.this,cId,Toast.LENGTH_LONG).show();
    ...
    public void onMapReady(final GoogleMap googleMap) {
        ...
        gMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                ...
                Intent i = new Intent(getApplicationContext(),GrDogActivity.class);
    ...
    public void actionListeners(){
        ...
        btnLogout.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                editor.commit();
                Intent i=new Intent(DogMapActivity.this,LoginActivity.class);
                startActivity(i);
            }
        });
    ...
    private void setMarkers(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(DogMapActivity.this, error.getMessage(), Toast.LENGTH_LONG).show();
            }
        }) {
            @Override
        ...
        MySingleton.getInstance(DogMapActivity.this).addToRequestQueue(stringRequest);
